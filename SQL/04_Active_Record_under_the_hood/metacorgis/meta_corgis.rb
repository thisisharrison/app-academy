...
class MetaCorgiSnacks
  def initialize(snack_box, box_id)
    @snack_box = snack_box
    @box_id = box_id
    # methods get all the methods of SnackBox
    # grep gets get_xxx_info methods => returns [:get_bone_info, :get_kibble_info, :get_treat_info]
    # $1 gets matching snack name
